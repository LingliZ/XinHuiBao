...
@property(assign, nonatomic) CGFloat closeValue;

@property  BOOL isMoveFinger;


/*!
 最后一条k线宽度
 */
@property(assign, nonatomic) CGFloat axisRightBlack;

/**
 *  Y轴左侧距离行情图的边距
 */
@property (nonatomic, assign) CGFloat axisTextMarginRight;

/**
 *  Y轴右侧距离行情图的边距
 */
@property (nonatomic, assign) CGFloat axisTextMarginLeft;


/**
 *  X轴底部距离行情
 */
@property (nonatomic ,assign) CGFloat axisTextMarginBottom;


/**
 *  昨日收盘价的字体
 */
@property (nonatomic, assign) CGFloat lastCloseFontSize;


@property (nonatomic ,copy) NSString *meterX;
@property (nonatomic, copy) NSString *meterY;
