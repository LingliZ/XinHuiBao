...
@class GXCalendarPickerView;

@protocol GXCalendarPickerViewDelegate <NSObject>
...
@interface GXCalendarPickerView : UIView
@property (nonatomic,assign)BOOL isShow;
@property(nonatomic,weak) id<GXCalendarPickerViewDelegate> delegate;
