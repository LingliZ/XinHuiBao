...
- (void)cycleScrollViewDidScrollow:(SDCycleScrollView *)cycleScrollView didSlideOffset:(CGFloat)slideOffset;
...
@property (nonatomic, weak) id<GXCycleScrollViewDelegate> gxdelegate;
/** block方式监听点击 */
