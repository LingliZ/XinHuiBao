...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (itemIndex == 3) {
        if ([self.gxdelegate respondsToSelector:@selector(cycleScrollViewDidScrollow:didSlideOffset:)]) {
            [self.gxdelegate cycleScrollViewDidScrollow:self didSlideOffset:scrollView.contentOffset.x];
        }
    }
}
